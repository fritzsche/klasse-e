...
\begin{sol}{EF102}
  Die Zwischenfrequenz eines Überlagerungsempfänger hat den Vorteil, dass mit speziellen Filtern eine höhere \textbf{Trennschärfe} erreicht werden kann.
\end{sol} 
...
\begin{ohmchapter}
  Wir haben im letzten Kapitel mit dem Detektorempfänger ein Beispiel eines sogenannten \textbf{Geradeausempfänger} kennengelernt.
...
\begin{sol}{EI504}
 Ein 10:1 Frequenzteiler hat die Frequenz um einen Faktor 10 reduziert, aus \SI{10}{\mega\hertz} wurde \SI{1}{\mega\hertz} in der Anzeige.
