...
\begin{sol}{EG508}
    ...
    Aus Kabelverlust und Antennengewinn haben wir \SI{3}{\dB} also ein Faktor 2 laut der Umrechnungstabelle. Aus \SI{5}{\watt} werden mit dem Faktor 2 also \SI{10}{\watt}.
...
\begin{sol}{EG509}
    Aus Antennengewinn und Kabelverlust ergeben sind \SI{10}{\dB}, also Faktor 10 Gewinn. Aus \SI{0,6}{\watt} werden also \SI{6}{\watt}. Wir berücksichtigen aber noch den Dipol Gewinnfaktor von 1,64 und erhalten: $\SI{6}{\watt} \cdot 1,64 = \SI{9,84}{\watt}$
\end{sol}
...
\begin{sol}{EK105}
Hier müssen wir nicht den Personensicherheitsabstand bestimmen. Es wurde aber mit der Formal für die Fernfeldberechnung ermittelt wie müssen lediglich überprüfen ob der Abstand $d$ ausreicht.
...
Da die Rechnung erst ab \SI{13,64}{\meter} gültig ist, wir aber laut Frage \SI{3,65}{\meter} ermittelt haben, kann die Rechnung nicht verwendet werden. wir müssen z.B. Messen.
...
\begin{sol}{EK106}
    Wie in Frage \qref{EK105} überprüfen wir nur den Gültigkeitsbereich der Feldfeldberechnung. Wir wissen noch aus der vorherigen Frage, dass der Abstand im 80 m-Band näherungsweise \SI{13,64}{\meter} betrug. Wir finden eine seht ähnliche Angabe in der richtigen Antwort (A). 
    Da $\lambda$ im Zähler, muss für 160 m etwas der doppelte Abstand gelten, auch dass passt zu Antwort (A).
    Genau genommen sind die Angaben in Antwort (C) sogar noch kleiner. Diese Berechnungen währen also auch ungültig und Antwort (C) ist auch richtig. Aber die BnetzA lässt nur Antwort (A) zu.
\end{sol}
