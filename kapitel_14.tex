...
\begin{sol}{EG214} 
    ...
    Für einen Dipol gilt, dass die Hauptstrahlrichtung wie in (A) senkrecht zur Aufspannrichtung der Dipolhälften ist.    
\end{sol}
...
Der generelle Aufbau ist vielen zumindest durch TV- und Rundfunkantennen bekannt. Grob gesprochen besteht sie aus unterschiedlichen Elementen, die in Hauptstrahlrichtung immer kleiner werden. 
...
\begin{ohmchapter}
    Wir erinnern uns, dass die Angabe \unit{\dBi} einen Antennengewinn in Bezug auf den Isotropstrahler angibt und dBd den Gewinn im Bezug auf den Dipol. Der Unterschied sind die 2,15 dBi des Dipols.
\end{ohmchapter}
