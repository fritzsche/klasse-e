...
\begin{sol}{EG113}
   Wir suchen eine Antenne für den Mikrowellenbereich, die \qq{scharf bündelt}. Hier solltest Du die Parabolantenne kennen. Die Frage Antwort (B) ist auch etwas gemein formuliert: Den isotropen Strahler gibt es in der Praxis ja nicht. Also geht es um die Erregerantenne (Feed).
\end{sol}
