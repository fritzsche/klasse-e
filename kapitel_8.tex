...
\end{sol}
\begin{sol}{EF206}
    In der Frage geht es um \qq{unerwünschte Abstrahlungen}, wir müssen also abschirmen.    
\end{sol}
...
Beim Mischen entstehen aus den beiden Eingangsfrequenzen die Summen- und Differenzfrequenz:
...
Wie solch ein Mischer funktioniert, kannst Du mit dieser \href{https://fritzsche.github.io/klasse-e/mischer.html}{App auf Github}
\footnote{ \href{https://fritzsche.github.io/klasse-e/mischer.html}{https://fritzsche.github.io/klasse-e/mischer.html}} interaktiv ausprobieren.
...
Hier nur eine kurze Erklärung, wie sich dies mathematisch herleiten lässt. Für die Prüfung brauchst Du diese Details nicht zu wissen!
In unserem Beispiel haben wir ein empfangenes Signal $S_{\text{empf}}$ 
und das Signal eines lokalen Oszillators $S_{\text{LO}}$.
...
Ein multiplikativer Mixer wird unser Signal zu einem einfachen Ausgangssignal $S_{\text{out}}$ multipliziert:
...
\end{sol}
\begin{sol}{EF503}
    Im Blockschaltbild können wir die Sende-/Empfangsumschaltung erkennen, wie zwischen RX und TX umgeschaltet wird. Es ist also der \textbf{Transverter}.
\end{sol}
...
\begin{sol}{EF505}
    Diese Frage hat viele ähnliche Antworten. Lies Dir alle genau durch!
...
\begin{ohmchapter}
Der Transistor ist für moderne Verstärker das entscheidende Bauelement, das uns hilft, die Schaltungen auseinanderhalten zu können. Für viele Jahre wurden auch Röhren verwendet, die auch heute noch viele Amateurfunker verwenden. Allerdings kommen sie nicht mehr im Fragenkatalog vor.
\end{ohmchapter}  
