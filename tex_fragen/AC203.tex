\frage{AC203}
    {Beim Anlegen einer Gleichspannung \$U\$ = 1 V an eine Spule messen Sie einen Strom. Wird der Strom beim Anlegen von einer Wechselspannung mit \$U\_\{\textbackslash\{\}textrm\{eff\}\}\$ = 1 V größer oder kleiner?}
