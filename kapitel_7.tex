...
\begin{sol}{EK205}
  Du hast bestimmt schon so ein Kabel gesehen (siehe Bild am Anfang des Kapitels), wenn Du z.B. eine Lampe montiert hast.
  Das braune Kabel ist das eigentliche stromführende Kabel gegenüber dem Neutralleiter. Dies wird auch als Phase bezeichnet.
  Wenn Du die Farben kennst, bleiben nur noch die Antworten (C) und (A). Nur Antwort (A) ist richtig. 
\end{sol}
...
\begin{sol}{ED304} 
    ...
    Nach dem Transformator haben wir immer noch einen Sinus. Dann kommt die Diode, welche hier jeweils bei einer Hälfte des Sinus in Sperrrichtung betrieben wird und deshalb keine Spannung anliegt. Dies entspricht Bild (A).
\end{sol}
...
\begin{sol}{EK204} 
  Es ist sehr wichtig, dass Stromwert und Auslösecharakteristik verwendet werden, damit die Scherung nicht zu früh oder zu spät auslöst.
\end{sol}
